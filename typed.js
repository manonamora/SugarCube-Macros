...
Setting.addToggle("noanim", {
    ...
    desc     : "If disabled, you will not see any animation on the page. This does not include notifications.",
    default  : true,
});

/* This should go in the CSS
.macro-typed-cursor:after {
